...
import type { ContentCtx as TableContentCtx, ContentSnippet as TableContentSnippet } from './content-types.js'
...
export type { ContentCtx, ContentSnippet } from './content-types.js'
